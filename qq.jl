...
# EvolutionXVersion = getEvolutionXVersion()
# #开启循环
# while true
#     global robot, members, DotOSVersion, EvolutionXVersion
#     #监视各个ROM的版本状态
#     DotOSVersion = checkDotOSVersion(robot, DotOSVersion)
#     EvolutionXVersion =  checkEvolutionXVersion(robot, EvolutionXVersion)
#     #判断是否有新成员加入
#     members =  checkNewMembers(robot, members)
#     #监听群内消息，根据消息，匹配内容进行回应
#     monitorGroupMeaasage(robot)
# end
